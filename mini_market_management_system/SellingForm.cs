...
namespace mini_market_management_system
{
    public partial class SellingForm : Form
    {
        ...
        private void getTable()
        {
            ...
            DataTable table = new DataTable();
            adapter.Fill(table);
            DataGridView_poduct.DataSource = table;
        }
        ...
        private void DataGridView_poduct_Click(object sender, EventArgs e)
        {
            TextBox_name.Text = DataGridView_poduct.SelectedRows[0].Cells[0].Value.ToString();
            TextBox_price.Text = DataGridView_poduct.SelectedRows[0].Cells[1].Value.ToString();
        }
        ...
        private void button_add_Click(object sender, EventArgs e)
        {
            try
            {
                string insertQuery = "INSERT INTO Bill VALUES(" + TextBox_id.Text + ",'" + label_seller.Text + "','" + label_price.Text + "','" + grandTotal.ToString() + ")";
        ...
        {
            //we need DGVPrinterHelper For pdf file
            printer.Title = " Mdemy Mini Sell Lists";
            printer.SubTitle = string.Format("Date[0]", DateTime.Now.Date);
            printer.SubTitleFormatFlags = StringFormatFlags.NoClip;
        ...
        private void button_addorder_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                addRow.Cells[0].Value = TextBox_name.Text;
                addRow.Cells[0].Value = TextBox_price.Text;
                addRow.Cells[0].Value = TextBox_qty.Text;
                addRow.Cells[0].Value = Total;
