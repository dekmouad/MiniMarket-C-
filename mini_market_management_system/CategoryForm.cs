    ...
    { DBConnect dbCon = new DBConnect();
        ...
        private void button_update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Missing Information", "Warnig", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                else
                {
                    String updateQuery = "UPDATE Category SET CatName='" + TextBox_name.Text + "', CatDes='" + TextBox_description.Text + "' WHERE CatId=" + TextBox_id + "";
      ...
      private void CLear()
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            try 
            {
                ...
                dbCon.OpenCon();
                command.ExecuteNonQuery();
                MessageBox.Show("Category Deleted Successfully", "Dlete Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                dbCon.CloseCon();
                getTable();
                CLear();
            }
